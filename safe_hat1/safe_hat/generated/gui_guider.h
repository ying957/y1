...
LV_IMG_DECLARE(_bck_alpha_480x400);
LV_IMG_DECLARE(_lb_alpha_61x53);
LV_IMG_DECLARE(_jy_alpha_61x53);
LV_IMG_DECLARE(_jy_alpha_61x53);
LV_IMG_DECLARE(_lb_alpha_61x53);
LV_IMG_DECLARE(_start_alpha_64x59);
LV_IMG_DECLARE(_stop_alpha_64x59);
LV_IMG_DECLARE(_stop_alpha_64x59);
LV_IMG_DECLARE(_start_alpha_64x59);
LV_IMG_DECLARE(_phone_alpha_30x30);
LV_IMG_DECLARE(_phone_alpha_30x30);
LV_IMG_DECLARE(_phone_alpha_30x30);
LV_IMG_DECLARE(_phone_alpha_30x30);
